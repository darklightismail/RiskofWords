...
btna=tk.Button(root, text="MEDIUM",font="riskofrainsquare", width=7, height=1, bg="#f4ca60",activebackground="#FF0000")
...
def disapear_animation(z, i, y):
    ...
    if i <= 8:
        ...
        btn_dict[btn_list[z]].after(60, lambda: disapear_animation(z, i, y))  # after every 100ms
        i = i + 1


disapear_animation(29, 1, 8)
disapear_animation(20, 0, 9)
