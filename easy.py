...
file = open("C:/Users/dark/Desktop/WORK/MASTER SIM TAZA/S1/PYTHON/RISK OF  WORDS/easy.txt").readlines()
print(file)
for line in file:
...
btna=tk.Button(root, text="EASY",font="riskofrainsquare", width=5, height=1, bg="#a0fa4c",activebackground="#FF0000")
